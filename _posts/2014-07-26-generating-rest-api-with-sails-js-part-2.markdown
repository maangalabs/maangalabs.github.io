...
Now you have created an employee API with Sails. Sails give you standard REST API (GET, POST, PUT, DELETE) command functions while you generate the API. These APIs are autogenerated and you may not need to worry about the code for these APIs. Ee can test these APIs now.
I'm using <b>POSTMAN</b> - a Chrome extension to test the APIs.
